...
namespace FirstMultiVmApp.ViewModel
{
    public class DynamicDataVm : ViewModelBase
    {
        ...
        public DynamicDataVm()
        {
            ...
            //Messenger.Default.Register<string>(this, "MasterDataInfo", Update);   // using MVVM Light Messaging         token = einschränken welche Infos

            Messenger.Default.Register<PersonVm>(this, "MasterDataInfo", Update);   // using MVVM Light Messaging         token = einschränken welche Infos
        }
